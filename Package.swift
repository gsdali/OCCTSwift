...
let occtTarget: Target = useLocalBinary
    ...
    : .binaryTarget(
        name: "OCCT",
        url: "https://github.com/gsdali/OCCTSwift/releases/download/v1.0.0/OCCT.xcframework.zip",
        checksum: "3f3928e90eb6455ec9e83a99a09c57e76c97ca67e5c070faa1ac337bd1cbfca8"
    )
