...
let occtTarget: Target = useLocalBinary
    ...
    : .binaryTarget(
        name: "OCCT",
        url: "https://github.com/gsdali/OCCTSwift/releases/download/v0.170.0/OCCT.xcframework.zip",
        checksum: "2b549552791eaa42ee06b4767e410fac0b663ced1b2caf34c6ad828e49e9e5bf"
    )
